...
urlpatterns = [
    ...
    path("client/heatmap/start/", views.priority_heatmap_start, name="priority_heatmap_start"),
    path("client/heatmap/stop/", views.priority_heatmap_stop, name="priority_heatmap_stop"),
    path("client/heatmap/status/", views.priority_heatmap_status, name="priority_heatmap_status"),
    path("client/heatmap/preview/<str:run_id>/", views.priority_heatmap_preview, name="priority_heatmap_preview"),
    path("client/heatmap/artifact/<str:run_id>/<str:filename>", views.priority_heatmap_artifact, name="priority_heatmap_artifact"),
